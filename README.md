...
<p align="center">
  <img width="600" alt="Nifty Asset" src="https://github.com/nifty-oss/asset/assets/729235/a212c231-0fcf-4ef6-b1d2-67dde11a71cd" />
</p>
<p align="center">
...
The result is that different token standards must be defined in separate programs, which then results in a bloated (multiple accounts) standard – e.g., `mint`, `token` and (potentially) `metadata` accounts, in addition to SPL Token and a Metadata programs. For most operations, all `5` accounts would be needed to interact with a non-fungible – and there are standard that the number of accounts is even higher.
...
- The program is lightweight and uses a minimal set of accounts.
