...
import { fetchDigitalAssetWithToken } from '@metaplex-foundation/mpl-token-metadata';
import {
  TokenState,
  findAssociatedTokenPda,
} from '@metaplex-foundation/mpl-toolbox';

test('it can bridge an asset to a token', async (t) => {
...
test('it can bridge a token to an asset', async (t) => {
  // Given a Umi instance.
  const umi = await createUmi();
